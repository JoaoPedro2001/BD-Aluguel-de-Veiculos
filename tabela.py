...
def populate_initial_data():
    with get_session() as session:
        ...
        agencia_centro = Agencia(
            nome_agencia='Agência Central',
            endereco='Rua A, 100',
            telefone='(11) 3333-4444',
            email='central@locadora.com'
        )
        agencia_aeroporto = Agencia(
            nome_agencia='Agência Aeroporto',
            endereco='Terminal 2 - Aeroporto Internacional',
            telefone='(11) 9999-8888',
            email='aeroporto@locadora.com'
        )
        ...
        veiculo_1 = Veiculo(
            ...
            agencia_id=agencia_centro.id_agencia
        )
        veiculo_2 = Veiculo(
            placa='XYZ9B87',
            modelo='Jeep Compass',
            ...
            agencia_id=agencia_aeroporto.id_agencia
        )
        veiculo_3 = Veiculo(
            placa='DEF4C56',
            modelo='BMW X5',
        ...
        print(f"Agências: 2 | Categorias: 3 | Atendentes: 2 | Veículos: 3 | Clientes: 2 | Reservas: 1 | Pagamentos: 1 | Manutenções: 1 | Multas: 1")
